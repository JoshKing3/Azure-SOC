...
In this project, I configured a cloud-based SOC in Azure, using Microsoft Sentinel as our SIEM. Set up logging, and alerts, and practiced incident response against live malicious traffic.
